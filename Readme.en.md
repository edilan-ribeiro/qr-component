  ...
  <ol>
    <li>
      ...
      <ul>
        ...
        <li><a href="#highlights">Continued development</a></li>
      </ul>
    </li>
...
Despite being a simple project, React ends up imposing some challenges, such as the lack of a reset for styles.

In general, a simple training session to better understand the particularities of the most basic part of React.

As there are no other components, it is not necessary to use props at this time.
...
After cloning or forking you will need to install the project dependencies, use the command:
```shell
npm install
```
